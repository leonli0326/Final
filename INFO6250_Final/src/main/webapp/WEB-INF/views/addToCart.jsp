		...
		<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand navbar-left" href="/home">Amazon Next</a>
				</div>
				<div class="collapse navbar-collapse">
				<sec:authorize access="isAuthenticated()"> 
					<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="/viewPayment">My Payment</a></li>
										<li><a href="/viewAddress">My Address</a></li>
										<li class="divider"></li>
				...
				<sec:authorize access="!isAuthenticated()">
					...
					<c:choose>
						...
						<c:otherwise>
							<ul class="nav navbar-nav navbar-right">
								<li><a href="/userRegister">New User? Register Now!</a></li>
								<li><a href="/spring/cart/view">My Cart</a></li>
		...
		<div class="container">
			<div class="jumbotron">
				<div class="row">
					...
					<p>${successMessage}</p>
					<p>
						<a class="btn btn-success btn-default" href="/spring/cart/view">View Cart</a>
						<a class="btn btn-primary btn-default" href="/spring/">Continue Shopping</a>
					</p>
				</div>
			</div>
		</div>
