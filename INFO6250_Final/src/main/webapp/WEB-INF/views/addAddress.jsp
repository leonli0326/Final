							...
							<table class="table">
								<c:forEach var="address" items="${userAddressesList}">
									<tr>
										...
										<td><a href="/spring/address/setDefault?selectedAddressId=${address.id}">Set Default</a></td>
									</tr>
								</c:forEach>
							</table>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<form method="post">
								...
								<div class="form-group">
									<label for="isDefault">Set as default Address</label> <input type="checkbox" name="isDefault" path="isDefault" value="true" />
								</div>
