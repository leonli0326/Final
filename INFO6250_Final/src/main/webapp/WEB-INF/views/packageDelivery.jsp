...
<body>
		...
		<!-- Fixed navbar end-->
	<div class="container">
		<c:forEach var="deliveryPackage" items="${deliveryPackages}">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-3">
							<p class="lead">${deliveryPackage.getStartTimeToString()}</p>
							<p>Address: ${deliveryPackage.getAddress()}</p>
						</div>

						<div class="col-lg-6">
							<p class="lead">
								Status: <span class="text-warning">${deliveryPackage.packageStatus}</span><span class="text-primary"> ${deliveryPackage.getEndTimeToString()}</span>
							</p>
							<table class="table">
								<c:forEach var="orderItem" items="${deliveryPackage.orderItems}">
									<tr>
										<td>
											<div class="col-lg-3">
											...
											<div class="col-lg-9">
												${orderItem.stock.product.productName} <br /> <span class="text-success"><b>EAN: ${orderItem.stock.product.productEAN}</b></span> <br /> Amount: ${orderItem.orderedCount}
											</div>
										</td>
									</tr>
								</c:forEach>
						...
						<div class="col-lg-3">
							<a class="btn btn-block btn-success" href="process?packageId=${deliveryPackage.id}">Process Package</a>
						</div>
					</div>
					<!-- row -->
				</div>
