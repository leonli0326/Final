			...
			<div class="col-lg-6 col-lg-offset-3">
				<form role="form" action="<c:url value='j_spring_security_check' />" method="post">
					...
					<div class="form-group">
						<label for="newPassword">New Password:</label> <input type="text" class="form-control" name="newPassword" required="required" >
						<p class="text-danger">${newPasswordError}</p>
					</div>
					<div class="form-group">
						<label for="confirmNewPassword">Confirm New Password:</label> <input type="password" class="form-control" name="confirmNewPassword" required="required">
					</div>
					<p class="text-danger">${newPasswordMismatch}</p>
